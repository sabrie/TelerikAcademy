...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        Racket playerRacket;
        int sleepTime; // // Еxersice 2: add a field sleepTime
        ...
        // Еxersice 2: add a constructor that takes the sleepTime as a parameter
        ...
        {
            // Exercise 3: remove the previous racket from this.allObjects
